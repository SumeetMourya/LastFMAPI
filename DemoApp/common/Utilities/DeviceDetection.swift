...
extension UIDevice {
    ...
    func versionGreaterThanOrEqualTo(version: String) -> Bool {
    ...
    func versionLessThanOrEqualTo(version: String) -> Bool {
        return UIDevice.current.systemVersion.compare(version, options: String.CompareOptions.numeric) != ComparisonResult.orderedDescending
    }
    ...
    struct DeviceType {
        ...
        static let IS_IPHONE_X_OR_BIGGER    = UIDevice.current.userInterfaceIdiom == .phone && ScreenSize.SCREEN_MAX_LENGTH >= 812.0
    ...
    static var isiPhoneX: Bool {
        return UIDevice.DeviceType.IS_IPHONE_X
    }
    
    static var isiPhoneXorBigger: Bool { //Need to know for resizing TabBar in UserProfile
        return UIDevice.DeviceType.IS_IPHONE_X_OR_BIGGER
    }
    
    static var isiPhone4: Bool {
        return UIDevice.DeviceType.IS_IPHONE_4_OR_LESS
    }
    
    
    static var isHavingCurved: Bool {
        return UIDevice.extraTop() > 20
    }
